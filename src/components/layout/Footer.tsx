...
export const Footer = () => {
  return (
    <footer className="bg-estate-navy text-white bg-[url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center">
      <div className="bg-estate-navy/90 w-full">
